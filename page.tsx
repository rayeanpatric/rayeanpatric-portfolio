...
// Particle animation component would go here
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10 grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <Link href="mailto:patricrayean@gmail.com">
                <Button
                  variant="outline"
                  size="lg"
                  className="gap-2 hover:bg-purple-500 hover:text-white transition-all"
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 bg-gray-900/50 border-gray-800 hover:border-purple-500 transition-all group">
              ...
              <h3 className="text-xl font-bold mb-2">Face Detection Edge System</h3>
              <p className="text-gray-300 mb-4">
                Real-time face detection system using MTCNN, deployed on Jetson Nano with 92% accuracy
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            <Card className="p-8 bg-gray-900/50 border-gray-800 hover:border-purple-500 transition-all">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Analyzed 35 studies on AI-driven models for cardiovascular disease risk assessment
                </p>
              </div>
            </Card>
            ...
            <Card className="p-8 bg-gray-900/50 border-gray-800 hover:border-purple-500 transition-all">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Integrated IoT sensors for real-time traffic monitoring and management
                </p>
              </div>
            </Card>
          </div>
        ...
        <div className="container px-4 md:px-6 mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="gap-2 hover:bg-cyan-500 hover:text-white transition-all"
            >
              <Link href="tel:+918903847468">
